...
class MetaGenerator {
  ...
  #defaultManifest = {
    name: "FlowZint Care AI",
    short_name: "FlowZint Care",
    display: "standalone",
  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "FlowZint Care AI — Returns Desk",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://flowzint.in" },
      },
      {
        tag: "meta",
        props: {
      ...
      },
      {
        ...
        props: {
          property: "og:image",
          content: "/flowzint-care-logo.svg",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://flowzint.in" },
      },
      {
        tag: "meta",
        props: {
