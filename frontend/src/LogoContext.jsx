...
import FlowZintLogo from "/flowzint-care-logo.png";
import FlowZintLogoDark from "/flowzint-care-logo.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(FlowZintLogoDark) : setLogo(FlowZintLogo);
