...
export default {
  ...
  github: () => {
    return "https://github.com/Akasxh/flowzint-care-ai";
  },
  discord: () => {
    return "https://flowzint.in/2026/ai/hackothon/";
  },
  docs: (path = "") => {
    const base = "https://github.com/Akasxh/flowzint-care-ai/blob/main";
    return path ? `${base}${path.startsWith("/") ? path : `/${path}`}` : `${base}/README.md`;
  },
  chatModes: () => {
    return "https://github.com/Akasxh/flowzint-care-ai/blob/main/docs/DEMO_GUIDE.md";
  },
  mailToMintplex: () => {
    return "mailto:care-ai@flowzint.in";
  },
  mailToSupport: () => {
    return "mailto:care-ai@flowzint.in";
  },
  hosting: () => {
    return "https://github.com/Akasxh/flowzint-care-ai#quickstart-openai-only";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://github.com/Akasxh/flowzint-care-ai/blob/main/README.md";
    },
  },
