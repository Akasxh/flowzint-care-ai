...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "FlowZint Care AI töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast FlowZint Care AI-i",
      description:
        "Aita meil FlowZint Care AI sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad FlowZint Care AI-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid FlowZint Care AI-ist?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "FlowZint Care AI mobiilversioon",
    "community-hub": {
  ...
  general: {
    ...
    message: {
      ...
      body: "FlowZint Care AI eeliseid",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beeta",
        description:
          "Lubage piiramatu hulga tööriistade kasutamist ning vähendage küsimuse kohta kasutatavate tokenide arv kuni 80% – FlowZint Care AI valib automaatselt iga küsimuse jaoks sobivad oskused.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Sea FlowZint Care AI-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma FlowZint Care AI kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles FlowZint Care AI UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda FlowZint Care AI instantsi.",
    ...
    modal: {
      ...
      create: "Loo API võti",
      helper:
        "Pärast loomist saab API võtit kasutada sellele FlowZint Care AI-i instantsile programmiga ligi pääsemiseks ja selle seadistamiseks.",
      name: {
        label: "Nimi",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul FlowZint Care AI ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et FlowZint Care AI saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas FlowZint Care AI töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja FlowZint Care AI-i andmekäitluse kohta.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Mälestus",
        placeholder:
          "Näiteks kasutaja nimi on Joe, kasutaja töötab ettevõttes FlowZint Care AI jne.",
        create: "Loo",
        save: "Salvesta",
        cancel: "Katkuda\nTühista",
      },
  ...
  telegram: {
    title: "Telegrami bot",
    description:
      "Ühendage oma FlowZint Care AI instants Telegramiga, et saaksite vestleda oma tööruumidega igast seadmist.",
    setup: {
      step1: {
