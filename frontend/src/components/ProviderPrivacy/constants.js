import FlowZintIcon from "@/media/logo/anything-llm-icon.png";
...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of FlowZint Care AI.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "FlowZint Care AI Embedder",
    description: [
      "Your document text is embedded privately on this instance of FlowZint Care AI.",
    ],
    logo: FlowZintIcon,
  },
  openai: {
