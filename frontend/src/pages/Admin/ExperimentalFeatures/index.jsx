            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-white text-md flex flex-col gap-y-4">
                  <p>
                    Experimental features of FlowZint Care AI are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using FlowZint Care AI.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of FlowZint Care AI.
                      </li>
                      <li>
                  ...
                  <p>
                    ...
                    >
                      FlowZint Care AI documentation
                    </a>{" "}
                    or email{" "}
                    <a
