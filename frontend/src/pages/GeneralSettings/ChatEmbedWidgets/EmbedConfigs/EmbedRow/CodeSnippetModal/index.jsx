...
See embed setup in the FlowZint Care AI repo:
https://github.com/Akasxh/flowzint-care-ai/blob/main/demo/embed-snippet.html
-->
<script
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Akasxh/flowzint-care-ai/blob/main/demo/embed-snippet.html"
          target="_blank"
          rel="noreferrer"
          className="text-blue-300 light:text-blue-500 hover:underline"
        >
          View embed setup guide &rarr;
        </a>
      </div>
      <button
        disabled={copied}
