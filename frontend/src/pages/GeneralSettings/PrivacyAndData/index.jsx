      ...
      <div className="relative rounded-lg">
        ...
        <div className="flex flex-col items-left space-y-2">
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            look on{" "}
            <a
              href="https://github.com/Akasxh/flowzint-care-ai/blob/main/README.md"
          ...
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            so that we can continue to improve FlowZint Care AI for you.{" "}
            <a
              href="mailto:care-ai@flowzint.in"
              className="underline text-blue-400"
              target="_blank"
              rel="noreferrer"
            >
